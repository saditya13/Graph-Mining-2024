...
def efficient_train_eval(train_loader, val_loader, test_loader, xs, model_list, prog_list,  alpha_list, exit_list, optimizer, config):
    ...
    for data in test_loader:
        ...
        for i, m in enumerate(model_list):
            ...
            if i == 0:
                ...
                results = torch.rand(data.batch.max()+1, num_classes, device=out.device)
...
if __name__ == '__main__':
    ...
    for seed in range(5):
        ...
        if config.early:
            acc = efficient_train_eval(train_loader, val_loader, test_loader, xs_list, model_list, prog_list, alpha_list, exit_list, optimizer, config)
        else: 
            acc = efficient_train_eval(train_loader, val_loader, test_loader, xs_list, model_list, prog_list, alpha_list, exit_list, optimizer, config)
        print(seed, acc)
        acc_list.append(acc)
